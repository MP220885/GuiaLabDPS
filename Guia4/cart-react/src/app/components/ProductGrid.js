...
'https://proassetspdlcom.cdnstatics2.com/usuaris/libros/fotos/358/original/portada_pack-trilogia-el-senor-de-los-anillos_j-r-r-tolkien_202206071544.jpg',
 ...
 price: 30,
 image: 'https://m.media-amazon.com/images/I/41dZy8CP52L._SY445_SX342_.jpg',
 quantity: 1
 },
 {
 id: 4,
 ...
 price: 390,
 image: 'https://i5.walmartimages.com/seo/HARRY-POTTER-Pack-Harry-Potter-La-serie-completa-Harry-Potter-Paperback-Boxed-Set-Books-1-7-Paperback-9788418173196_983ae67f-131d-4378-ba10-3ceadef50dde.4d4a65cd092771e4c042cb948e26be06.jpeg',
 quantity: 1
 }
];
const ProductGrid = () => {
 ...
 <div key={product.id} className="product-card"><img src={product.image} alt={product.title} />
 <h3>{product.title}</h3>
 <p>${product.price}</p>
